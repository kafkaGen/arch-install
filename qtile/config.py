# some floating rules for some windows
# check logs
# fix some icons
...
from function import keyboard, backlight, left_arrow, bar_condition, bar_switch
...
keys = [
        ...
        # Key([mod, "c"], "b",
        #     lazy.function(bar_switch),
        #     desc='Switch bar view'
        #     ),
         Key([mod, "shift"], "r",
             lazy.restart(),
             desc='Restart Qtile'
...
def init_widgets_list(colors):
    widgets_list = [
              ...
              left_arrow(colors[8], colors[9]),
              widget.Image(
                       filename = '~/.config/qtile/icons/brightness.png',
                       scale = True,
                       background = colors[9],
                       margin_y = 1,
                       mouse_callbacks = {'Button1': lambda: os.system("xbacklight -set 50%"),
                                          'Button3': lambda: os.system("xbacklight -set 100%"),
                                          'Button4': lambda: os.system("xbacklight -inc 10%"),
                                          'Button5': lambda: os.system("xbacklight -dec 10%")},
                       ),
              widget.GenPollText(       #Backlight
                       func = backlight,
                       fmt = '{}%',
                       background = colors[9],
                       update_interval = 0.1,
              ...
              left_arrow(colors[9], colors[10]),
              widget.Image(
                       filename = '~/.config/qtile/icons/volume.png',
                       scale = True,
                       background = colors[10],
                       margin_y = 2,
                       mouse_callbacks = {'Button1': lambda: os.system("amixer -D pulse set Master 1+ toggle"),
                                          'Button3': lambda: qtile.cmd_spawn('pavucontrol-qt'),
                                          'Button4': lambda: os.system("amixer -q sset Master 2%+"),
                                          'Button5': lambda: os.system("amixer -q sset Master 2%-")},
                       ),
              widget.Volume(
                       background = colors[10],
                       fmt = '{}',
              ...
              left_arrow(colors[10], colors[11]),
              widget.TextBox(
                       text = "↯",
              ...
              widget.Net(
                       ...
                       background = colors[11],
                       padding = 3,
                       mouse_callbacks = {'Button3': lambda: qtile.cmd_spawn(myTerm + " -e nmtui")},
                       ),
...
def init_small_widgets_list(colors):
    widgets_list = [
              widget.Sep(
                       linewidth = 0,
                       padding = 6,
